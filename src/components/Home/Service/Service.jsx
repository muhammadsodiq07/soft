    ...
    <div className="service">
      <div className="container">
        <div className="service__main">
          <div className="service__title-div">
            <span className="service__title-span">Our Services</span>
            <p className="service__title">Service We Provide</p>
          </div>
          <ul className="service__list">
            {serviceArray.map((item, index) => (
              <li className="service__item" key={index} data-aos="fade-up">
                <Link to="/home/services">
                  <div className="service__inner-div">
                    <div className="service__inner-imgDiv">
                      <img
                    ...
                    <p className="service__inner-title">{item.title}</p>
                    <span className="service__inner-span">{item.text}</span>
                    <div className="service__innerDiv-box">
                      <span>
          ...
          <div className="service__email-div">
            <Email />
          </div>
        </div>
      </div>
